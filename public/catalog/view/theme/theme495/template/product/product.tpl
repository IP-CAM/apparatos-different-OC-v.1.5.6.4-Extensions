	...
	<div class="col-sm-8"><?php } else { ?><div class="col-sm-12"><?php } ?>
	  ...
	  <div class="description">
		<div class="product-section">
			...
			<?php } ?>
			<?php /* <span><?php echo $text_stock; ?></span><div class="prod-stock"><?php echo $stock; ?></div> */ ?>
		</div>
	  ...
	  <div class="cart">
		<div class="prod-row">
			<div class="cart-top">
				...
				<a id="button-cart" class="button-prod" ><span>ADICIONAR PARA LISTA DE ORÇAMENTO</span></a>

				<a id="button-cart" class=" buttom-fim-orc" ><span>FINALIZAR ORÇAMENTO</span></a>
				</div>
				<div class="extra-button">
					<div class="wishlist">
						<a title="<?php echo $button_wishlist; ?>" class="tooltip-1" onclick="addToWishList('<?php echo $product_id; ?>');"><i class="fa fa-star"></i></a>
					</div><div class="compare">
						<a title="<?php echo $button_compare; ?>" class="tooltip-1" onclick="addToCompare('<?php echo $product_id; ?>');"><i class="fa fa-bar-chart-o"></i></a>
					</div>
				</div>
				<div class="clear"></div>
				<?php if ($minimum > 1) { ?>
	  ...
	  <?php } ?>
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme495/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
  ...
  <div  class="related">
	...
	<div class="box-product"> 
		<ul class="related-slider">
			...
			<?php } ?>
			<div class="name maxheight-relat"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme495/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme495/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
