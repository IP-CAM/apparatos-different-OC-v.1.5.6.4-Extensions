...
class ModelCheckoutOrder extends Model {
	...
	public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mail/orcamento_order.tpl')) {
				$html = $template->fetch($this->config->get('config_template') . '/template/mail/orcamento_order.tpl');
			} else {
				$html = $template->fetch('default/template/mail/orcamento_order.tpl');
			}
