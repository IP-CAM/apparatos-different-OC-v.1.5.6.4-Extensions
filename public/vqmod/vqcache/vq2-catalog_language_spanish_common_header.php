...
$_['text_checkout']       = 'Realizar Pedido';
				...
				$_['text_welcome']  = '<li class="login_h last"><a href="%s"><i class="fa fa-lock"></i><span>Conectarse</span></a></li><li><a href="%s"><i class="fa fa-user"></i>Crear Cuenta</a></li>';
				$_['text_logged']   = '<li class="login_h"><a href="%s"><i class="fa fa-user"></i>%s</a></li> <li class="last"><a href="%s"><i class="fa fa-unlock"></i><span>Desconectar</span></a></li>';
				$_['text_account']  = 'Mi Cuenta';
