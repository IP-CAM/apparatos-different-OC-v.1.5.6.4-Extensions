...
$_['text_search']        = 'Suche';
$_['text_welcome']  = '<li class="login_h last"><a href="%s"><i class="fa fa-lock"></i><span>anmelden</span></a></li><li><a href="%s"><i class="fa fa-user"></i>erstellen</a></li>';
$_['text_logged']   = '<li class="login_h"><a href="%s"><i class="fa fa-user"></i>%s</a></li> <li class="last"><a href="%s"><i class="fa fa-unlock"></i><span>Abmelden</span></a></li>';
$_['text_account']       = 'Mein Konto';
$_['text_checkout']      = 'Kasse';
