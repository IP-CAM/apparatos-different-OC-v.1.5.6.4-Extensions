...
$(function(){
	...
	$("#content .banner").wrapAll("<div class='row'></div>");
		
	/***************************************************/	
	
	$('.box-category > ul > li > a, #content .banner .s-desc > div, .content-bottom .s-desc .icon').each(function(){
		var title = $(this).html();
...
/**********************************************************add icon aside li *****************************************************************************/
    $(document).ready(function(){
       ...
       $('aside').find('ul.info-list li>a').prepend('<i class="fa fa-angle-right"></i>');
	   $('aside').find('ul.afine li>a').prepend('<i class="fa fa-angle-right"></i>');
	   $('aside').find('ul.acount li>a').prepend('<i class="fa fa-angle-right"></i>');
...
/********************************** swipe ********************************************/
   jQuery(document).ready(function(){
	...
	jQuery('.swipe-control').click(function(){
	 if(jQuery(this).parents('body').find('#cart').hasClass('active')){
      jQuery(this).parents('body').find('#cart').removeClass('active');
      return false
     }
    })
