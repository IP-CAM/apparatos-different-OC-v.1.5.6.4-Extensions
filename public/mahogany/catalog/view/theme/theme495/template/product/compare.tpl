  ...
  <table class="compare-info table table-bordered">
	...
	<tbody>
	  ...
	  <tr>
		...
		<?php foreach ($products as $product) { ?>
		<td><img src="catalog/view/theme/theme495/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
	...
	<tr>
	  <td class="last-1"></td>
	  <?php foreach ($products as $product) { ?>
	  <td class="remove last-1 tcenter"><a href="<?php echo $product['remove']; ?>" ><i class="fa fa-trash-o"></i><!--<?php echo $button_remove; ?>--></a></td>
	  <?php } ?>
	</tr>
  </table>
  </div>
